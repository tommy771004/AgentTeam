...
export const DEFAULT_PI_CAPABILITIES: PiCapability[] = [
  ...
  { id: 'delegate', description: 'Sub-agent delegation through child sessions.', tools: ['delegate_task', 'delegate_status', 'delegate_adopt_results'], runbook: 'Children need role, profile, context, and depth; parent goal results require an explicit Host Checker adoption.', deferLoading: true },
