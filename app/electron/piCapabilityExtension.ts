...
export const DEFAULT_PI_CAPABILITIES: PiCapability[] = [
  ...
  { id: 'mcp-bridge', description: 'Reach configured MCP servers from the loop.', tools: ['mcp_list_tools', 'mcp_call'], runbook: 'Only enabled extension ids resolve; calls are approval-gated.', deferLoading: true },
