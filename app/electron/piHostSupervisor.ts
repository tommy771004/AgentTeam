...
export class PiHostSupervisor {
  ...
  constructor(fork: PiHostFork, options: PiHostSupervisorOptions = {}) {
    ...
    this.requestedCapabilities = options.requestedCapabilities
      ...
      : ['attachments-v1', 'tool-contract-v1', 'instructions-v1', 'review-v1', 'agent-tree-v1', 'agent-collaboration-v1', 'goal-contract-v1', 'workflow-graph-v1', 'workflow-record-v1', 'workflow-scheduler-v1', 'fresh-semantic-verifier-v1']
