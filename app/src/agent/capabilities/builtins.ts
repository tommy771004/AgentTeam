...
- Otherwise mcp_list_tools then mcp_call with correct serverId/toolName.`,
  ...
  {
    id: 'custom-tools',
    description: 'Execute user-configured command or HTTP templates without exposing credential values.',
    instructions: 'Use custom_tool_execute only for a configured tool name. Never place credentials in tool input.',
    toolNames: ['custom_tool_execute'],
    approvalTools: ['custom_tool_execute'],
    deferLoading: true,
    source: 'builtin',
    group: 'integrations',
  },
