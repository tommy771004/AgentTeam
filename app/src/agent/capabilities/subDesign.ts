...
- In Critique, return four 0–100 scores (brief coverage, brand conformance, accessibility, implementation readiness), findings with severity/path, and pass or needs-revision.
