...
register({
  ...
  schemaParams: {"type":"object","properties":{"manifest":{"type":"object","description":"Artifact manifest. entry and supportingFiles are project-relative only.","properties":{"id":{"type":"string"},"briefId":{"type":"string"},"kind":{"type":"string","enum":["html","deck","react-component","markdown-document","svg"]},"title":{"type":"string"},"entry":{"type":"string"},"renderer":{"type":"string","enum":["html","deck-html","markdown","svg","code"]},"exports":{"type":"array","items":{"type":"string","enum":["html","pdf","zip","pptx","mp4","jsx","md","svg","txt"]}},"supportingFiles":{"type":"array","items":{"type":"string"}},"tweaks":{"type":"array","maxItems":32,"description":"Structured live controls. replaceTemplate must contain literal {{value}}.","items":{"type":"object","properties":{"id":{"type":"string"},"label":{"type":"string"},"kind":{"type":"string","enum":["color","text","number","select","boolean"]},"path":{"type":"string"},"find":{"type":"string"},"replaceTemplate":{"type":"string"},"value":{"type":"string"},"defaultValue":{"type":"string"},"min":{"type":"number"},"max":{"type":"number"},"step":{"type":"number"},"options":{"type":"array","items":{"type":"string"}}},"required":["id","label","kind","path","find","replaceTemplate"]}},"status":{"type":"string","enum":["streaming","complete","error"]},"revision":{"type":"integer"}},"required":["id","kind","title","entry","renderer"]},"briefId":{"type":"string","description":"Optional when the thread is linked to a brief."}},"required":["manifest"]} as Record<string, unknown>,
