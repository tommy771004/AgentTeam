...
try {
  ...
  assert.deepEqual(initialized.result, {
    ...
    capabilities: ['health', 'settings', 'sessions', 'turns', 'runtime', 'tools', 'tool-contract-v1', 'attachments-v1', 'events', 'automation', 'resources', 'memory', 'memory-store-v1', 'memory-control-v1', 'instructions-v1', 'review-v1', 'capabilities'],
    status: 'ready',
  })
