...
assert.deepEqual(result.settings, { provider: 'openai', model: 'gpt-pi', thinkingLevel: 'high', activeTools: ['read'], compaction: 'manual', approvalMode: 'auto', unattended: false })
