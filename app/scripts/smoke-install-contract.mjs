...
const releaseWorkflow = fs.readFileSync(path.join(appRoot, '..', '.github', 'workflows', 'release.yml'), 'utf8')
...
assert.match(installLifecycle, /\.\/packaged-install-evidence\.mjs/)
assert.match(releaseWorkflow, /verify-packaged-install-evidence\.mjs/)
assert.doesNotMatch(releaseWorkflow, /firstTask\.diffPreview/)
