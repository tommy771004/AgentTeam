...
|--------|------|----------|-------|
| **release-qualification-hardening** | [spec.md](release-qualification-hardening/spec.md) | [03 Verified channel promotion](release-qualification-hardening/issues/03-verified-channel-promotion.md) | 01–02 已 resolved：packaged change evidence schema v2 已對齊，package jobs 現為 candidate-only，qualification failure 前無 customer publication capability；下一步由 03 建立唯一 protected publish owner。Paid Beta 仍維持 NO-GO（0/43），不得由本地 build 或 unsigned artifacts 推導 ready。 |
