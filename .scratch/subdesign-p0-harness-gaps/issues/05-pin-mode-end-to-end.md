...
- [x] 元件層 fixture：pin UI 狀態流（idle → pinning → submitted）
...
**2026-08-28 fixture 收口**：`scripts/smoke-subdesign-pin-component.mjs` 以真 Chromium 驗證 idle → pinning → submitted，並斷言 iframe 外偽造 message 不會建立 pin；本機實跑通過。
