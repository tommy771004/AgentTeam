# 12 — 交付 Spec → Tickets → TDD → Review 訂閱工作流

**What to build:** Let a subscriber run the product's flagship development workflow from an approved objective to a user-reviewable result.
