...
- [ ] Any remaining warning, known issue, or platform limitation is recorded in the release report with owner and mitigation.
- [ ] Release is marked Go only when every P0 criterion has stored evidence; otherwise it remains No-Go.
