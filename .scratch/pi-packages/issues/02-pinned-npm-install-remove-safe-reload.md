...
- 2026-09-01：`npm run smoke:pi-packages` 完整覆蓋 pinned install/remove、runtime reload 與 active-run refusal；原 durable-memory revision 失敗點及兩個 store contract 均獨立通過，收口為 `resolved`。
