...
- 2026-09-01：shipped Host lifecycle 再次證明 Chat／SubDesign 共用 frozen package skill provenance，remove 後新一輪消失；原 instruction snapshot 與 durable-memory store contracts 全部通過，收口為 `resolved`。
