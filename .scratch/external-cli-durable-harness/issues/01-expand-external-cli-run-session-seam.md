...
- [ ] Existing Codex, Claude, Grok, Gemini, Cursor, and OpenCode invocations route through the same session contract without duplicating adapter command construction.
