...
- Runner capability matrix: builtin is `executionKind: 'loop'` with parse/DoD/iterate/continueGoal; external CLI is `'external'` with none of them, and CLI success is never DoD met.
